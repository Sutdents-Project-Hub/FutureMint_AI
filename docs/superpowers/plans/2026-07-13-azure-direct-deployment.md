...
| Item | Responsibility |
|---|---|
| `services/api` | Functions API、Azure AI orchestration、Cosmos access、deterministic calculations |
| `apps/client` | Connected-mode Flutter Web client |
...
**Files:**
- Execute: `services/api/scripts/seedCosmosDemo.ts`
- Modify with results: `docs/testing-and-evidence.md`
...
**Files:**
- Deploy from: `apps/client`
- Artifact: `apps/client/build/web`
