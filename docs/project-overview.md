...
青少年開始獨立面對零用錢、交通、飲食、遊戲與數位訂閱，卻常只有「月底才發現錢不夠」的記帳結果。主要 Persona 是開始自行管理日常開銷與數位消費的中學生；家長可透過邀請碼建立受控家庭關聯，但只查看孩子的預算與趨勢摘要，不查看交易明細或監控原始流水。上班族與銀髮族不進入本次 MVP。
...
5. AI 以最小摘要產生學習路線與微課，提供一個觀念、一個例子與一個可行動選擇；學習頁可自由提問並選擇回答方式。
...
| 學習規劃與微課 | 與摘要相關、含限制提示；來源標示量界或 Demo，支援自由提問／回答方式，AI 非繁中輸出會被 schema 拒絕 |
