...
目前品牌方向為帶淡紫灰色調的近白畫布、扁平圓角色塊、深靛主行動與手機導覽，以及有表情的幾何金錢夥伴。靛藍、黃色、薰衣草紫、長春花藍、天空藍、橙與粉紅只用在明確功能層級；一般卡片預設無框無陰影，需要區隔時才使用 1dp hairline。深色模式以深靛藍／紫灰表面與較亮層級表達深度，不直接反相亮色卡片。
